...
public class Dispensing {
    ...
    private Date initDate, finalDate; // The period private boolean isCompleted;
//    ??? // The set of medicines to dispense and its control, among others public Dispensing() {. . .} // Makes some inicialization
